...
document.querySelectorAll('.menu-word').forEach(word => {
  word.addEventListener('click', () => {
    ...
    setTimeout(() => {
      const btn = document.querySelector(`.filter-btn[data-filter="${sub}"]`)
...
function openCart(id) {
  ...
  document.getElementById('alt-form-section').style.display = 'none';
  document.getElementById('alt-name-input').value    = '';
  document.getElementById('alt-message-input').value = '';
...
document.getElementById('show-alt-btn').addEventListener('click', () => {
  document.getElementById('alt-form-section').style.display = 'block';
});
...
document.getElementById('alt-form').addEventListener('submit', function(e) {
  ...
  emailjs.send("service_cr14gir", "template_dlmqm35", {
    ...
    message:      document.getElementById('alt-message-input').value,
